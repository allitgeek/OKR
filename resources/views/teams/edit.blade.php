                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('teams.update', $team) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="description" name="description" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('description', $team->description) }}</textarea>
                        ...
                        <div class="mt-4">
                            ...
                            <select id="parent_team_id" name="parent_team_id" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                @foreach ($teams as $parentTeam)
                                    <option value="{{ $parentTeam->id }}" {{ old('parent_team_id', $team->parent_team_id) == $parentTeam->id ? 'selected' : '' }}>
                                        {{ $parentTeam->name }}
                                    </option>
                                @endforeach
                            </select>
