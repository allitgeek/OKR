...
<nav x-data="{ open: false }" class="bg-gradient-to-r from-indigo-900 via-blue-900 to-purple-900 shadow-xl border-b border-indigo-800/30">
    <!-- Primary Navigation Menu -->
        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="shrink-0 flex items-center group">
                    <a href="{{ route('dashboard') }}" class="flex items-center space-x-3 transition-transform duration-200 hover:scale-105">
                        <div class="flex items-center justify-center w-10 h-10 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl shadow-lg">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="flex items-center sm:hidden">
                    <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-lg text-indigo-200 hover:text-white hover:bg-white/10 focus:outline-none focus:bg-white/10 transition duration-200 ease-in-out">
...
<!-- Add required CSS for smooth animations -->
<style>
